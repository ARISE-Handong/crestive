# 1 "../test/example1/example1.c"
# 1 "<built-in>"
# 1 "<command-line>"
# 1 "../test/example1/example1.c"
# 12 "../test/example1/example1.c"
# 1 "./../include/crest.h" 1
# 136 "./../include/crest.h"
typedef enum {
...
# 18 "../test/example1/example1.c" 3 4
                        __stderrp
# 18 "../test/example1/example1.c"
                              , "%d\n", a) ;
  __CrestInt(&b) ; fprintf(
# 19 "../test/example1/example1.c" 3 4
                        __stderrp
